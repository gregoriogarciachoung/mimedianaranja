...
('Cercado Lima'),('Los olivos'),('Independencia'),('ANCON'),('ATE'),('BARRANCO'),('BREÑA'),('BELLAVISTA'),('CALLAO'),('CARABAYLLO'),('CHACLACAYO'),('CARMEN DE LA LEGUA REYNOSO'),('CHORRILLOS'),('CIENEGUILLA'),('COMAS'),('EL AGUSTINO'),('JESUS MARIA')
,('LA PERLA'),('LA PUNTA'),('LA MERCED'),('LA MOLINA'),('LA VICTORIA'),('LINCE'),('LURIGANCHO'),('LURIN'),('MAGDALENA DEL MAR'),('MIRAFLORES'),('PACHACAMAC'),('PUCUSANA',9),('PUEBLO LIBRE'),('PUENTE PIEDRA')
,('PUNTA HERMOSA'),('PUNTA NEGRA'),('RIMAC'),('SAN BARTOLO'),('SAN BORJA'),('SAN ISIDRO',9),('SAN JUAN DE LURIGANCHO'),('SAN JUAN DE MIRAFLORES'),('SAN LUIS'),('SAN MARTIN DE PORRES');
,('SAN MIGUEL'),('SANTA ANITA'),('SANTA ROSA'),('SANTIAGO DE SURCO'),('SURQUILLO'),('VILLA EL SALVADOR'),('VILLA MARIA DEL TRIUNFO'),('VENTANILLA');
